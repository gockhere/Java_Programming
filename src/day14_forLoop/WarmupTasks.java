...
public class WarmupTasks {
    ...
    public static void main(String[] args) {
       ...
       String str3= combine("one","eight");
        ...
        String s1= ""+true; //"true" ==> makes boolean to string

        System.out.println("===============================");

        System.out.println(sumOf2IntegerNumbers(10,20) );

        System.out.println(sumOf3IntegerNumbers(33,43,24));

        System.out.println(sumOf4IntegerNumbers(55,23,13,53));
    ...
    public static String combine(String str1, String str2){
        ...
        if (str1 .charAt(str1.length()-1)==str2.charAt(0) ){//if the last character of first string is equal to the first character of the second string
