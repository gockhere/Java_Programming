...
public class StringMethods2 {
    public static void main(String[] args) {
        ...
        //sentence2=sentence2.replace("Java","Python"); -->makes all java turn to python
        sentence2=sentence2.replaceFirst("Java", "Python"); // makes first java turn to python
        ...
        sentence3=sentence3.replaceFirst(", Java", ", Python");// way to change second Java
