...
public class CollectionsUtilityMethods {
    public static void main(String[] args) {
        ...
        list.addAll(Arrays.asList(10,20,20,30,40,40,50,50,50,50,50,60,60,50,50,50,50));
        ...
        numbers.addAll(Arrays.asList(10,20,20,30,40,40,50,50,50,50,50,60,60,50,50,50,50));
